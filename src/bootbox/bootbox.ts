...
function init() {
   ...
   */
  exports.locales = function (name:any) {
   ...
   */
  exports.addLocale = function (name:any, values:any) {
   ...
   * @returns The updated bootbox object
   */
  exports.removeLocale = function (name:any) {
    if (name !== 'en') {
      delete locales[name];
    }
    else {
   ...
   * @returns The updated bootbox object
   */
  exports.setLocale = function (name:any) {
  ...
  exports.hideAll = function () {
    //$('.bootbox').modal('hide');
    let dialog = new Modal($('.bootbox').get(0) as HTMLElement);
    dialog.hide();
    return exports;
  };
   ...
   */
  exports.dialog = function (options:any) {

    options = sanitize(options);
    let modal = $.fn.modal as any;
    ...
    if (getKeyLength(options.buttons) > 0) {
      each(buttons, function (key:any, b:any) {
  ...
  exports.prompt = function () {
    ...
    options.buttons.confirm.callback = function () {
      ...
      if (options.inputType === 'checkbox') {
        value = input.find('input:checked').map(function (item:any) {
          return $(item).val();
        }).get();
        ...
        if (el.checkValidity && !el.checkValidity()) {
          ...
          if (options.inputType === 'select' && options.multiple === true) {
            value = input.find('option:selected').map(function (item:any) {
              return $(item).val();
            }).get();
          }
          else {
    ...
    switch (options.inputType) {
      ...
      case 'select':
        ...
        each(inputOptions, function (_:any, option:any) {
        ...
        each(groups, function (_:any, group:any) {
          input.append(group);
        });
      ...
      case 'checkbox':
        ...
        each(inputOptions, function (_:any, option:any) {
          ...
          each(checkboxValues, function (_:any, value:any) {
  ...
  //
  function mapArguments(args:any, properties:any) {
  ...
  function mergeArguments(defaults:any, args:any, properties:any) {
    return $.extend(
      // Deep merge
      true,
  ...
  function mergeDialogOptions(className:any, labels:any, properties:any, args:any) {
    let locale;
    if (args && args[0]) {
  ...
  function validateButtons(options:any, buttons:any) {
    let allowedButtons:any = {};
    each(buttons, function (key:any, value:any) {
      allowedButtons[value] = true;
    });

    each(options.buttons, function (key:any) {
  ...
  function createLabels(labels:any, locale:any) {
    let buttons:any = {};
  ...
  function getText(key:any, locale:any) {
  ...
  function sanitize(options:any) {
    ...
    each(buttons, function (key:any, button:any, index:any) {
  ...
  function bindOne(dialog:any,type:string,callback:Function) {
    function takeOne() {
      callback({data: {dialog: dialog}});
  ...
  function processCallback(e:any, dialog:any, callback:Function) {
    e.stopPropagation();
    e.preventDefault();
  ...
  function minAndMaxAreValid(type:any, min:any, max:any) {
    let result = false;
    let minValid = true;
    let maxValid = true;
  ...
  function timeIsValid(value:any) {
    return /([01][0-9]|2[0-3]):[0-5][0-9]?:[0-5][0-9]/.test(value);
  }

  function dateIsValid(value:any) {
